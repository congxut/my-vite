            ...
            >
              <div class="lg:pl-20">
                <div class="max-w-xs px-2.5 lg:max-w-none">
                  <img
                    ...
                    srcset=""
                    src="https://images.unsplash.com/photo-1684577088722-d46fd87aaa09?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDIwfENEd3V3WEpBYkV3fHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60"
              ...
              <div class="lg:pl-20">
                <ul role="list">
                  <li class="flex">
                    <a
                      class="group flex text-sm font-medium text-zinc-800 transition hover:text-teal-500  dark:hover:text-teal-500"
                      href="/about#"
                      ><svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
